...
class WorkloadInfo(object):
    ...
    def __init__(self, nodes):
        ...
        print('name', self.rel_names)
        print('id', self.rel_ids)
        print('scan', self.scan_types)
        print('join', self.join_types)
        print('ops', self.all_ops)
        print('attrs', self.all_attributes)
